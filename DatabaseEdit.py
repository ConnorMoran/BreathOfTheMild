...
#         self.place(relwidth=0.8, relheight=0.8, relx=0.1, rely=0.1)
    ...
    def create_table(self):
        ...
        if self.controller.get_connection() is not None:
            ...
            functions_button = Button(self, text="Display Functions", command=lambda: self.controller.show_frame("functionFrame"))
            self.controller.get_function_Frame().set_page(self.current_table)
